...
#include "corhdr.h"
    ...
    STDAPI_(void)
    AddDestructorCallback(int code, TDestructorCallback callback);
...
#define INTERFACE IMapToken
    ...
    {
        STDMETHOD(Map)
        (mdToken tkImp, mdToken tkEmit) PURE;
    };
...
#define INTERFACE IMetaDataFilter
    DECLARE_INTERFACE_(IMetaDataFilter, IUnknown)
    {
        ...
        (mdToken tk, BOOL * pIsMarked) PURE;
    };
...
#define IMAGE_REL_BASED_IA64_PCREL60 12
    ...
    DECLARE_INTERFACE_(ICeeGen, IUnknown)
    {
        ...
        (
            ...
            _Out_opt_
                    LPWSTR *
                lpString) PURE; // [OUT] Returned string
